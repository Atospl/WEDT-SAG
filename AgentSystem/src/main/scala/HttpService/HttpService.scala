...
object HttpService {
  ...
  def getSimilar(article :ArticleModel, articles: List[ArticleModel]): String = {
    var vector = ""
  ...
  def main(args: Array[String]): Unit = {
    val a = ArticleRepository.getByTagName(Tag.POLITICS.name)
    println(getSimilar(a.get.head, a.get))
  }
